...
locals {
  ...
  ip_ranges = {
    "router.dd.soeren.cloud" : ["192.168.65.1/32", "192.168.200.3/32"]
    "router.ez.soeren.cloud" : ["192.168.2.3/32", "192.168.200.2/32"]
    "router.pt.soeren.cloud" : ["192.168.73.1/32", "192.168.200.4/32"]
