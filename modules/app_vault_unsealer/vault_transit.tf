resource "vault_mount" "transit" {
  path                      = "transit/unsealer_${var.environment}"
  type                      = "transit"
  description               = "transit for Vault unsealer ${var.environment}"
...
resource "vault_policy" "transit_encrypt" {
  ...
  name = "transit_unsealer_${var.environment}_${each.value}_encrypt"
...
resource "vault_policy" "transit_decrypt" {
  ...
  name = "transit_unsealer_${var.environment}_${each.value}_decrypt"
...
resource "vault_policy" "transit_encrypt_decrypt" {
  ...
  name = "transit_unsealer_${var.environment}_${each.value}"
